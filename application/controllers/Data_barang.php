    ...
    public function ajax_barang()
    {
        ...
        if ($this->input->is_ajax_request()) {
            ...
            foreach ($list as $i) {
                ...
                $row[] = ($i->active == 'Y') ? '<center> Aktif' : '<center> Tidak Aktif';
                $row[] = '<center><a href="' . site_url('edit_barang/' . $i->kode_barang) . '" class="btn btn-warning btn-sm text-white">Edit</a></center>';
