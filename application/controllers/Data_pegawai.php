    ...
    public function ajax_pegawai()
    {
        ...
        if ($this->input->is_ajax_request()) {
            ...
            foreach ($list as $i) {
                ...
                $row[] = '<center><a href="' . site_url('pegawai/' . $i->username) . '" class="btn btn-success btn-sm">Detail</a>
                <a href="' . site_url('edit_pegawai/' . $i->username) . '" class="btn btn-warning btn-sm text-white">Edit</a>
                <button type="button" class="btn btn-info btn-sm text-white" data-toggle="modal" data-target="#modal-password" onclick="GantiPW(' . $i->id_user . ')">Ubah Password</button></center>';
